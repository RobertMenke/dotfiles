...
{  
  ...
  xdg = {
    configFile = {
      ...
      yabai.source = "${config.home.homeDirectory}/.dotfiles/yabai";
      skhd.source = "${config.home.homeDirectory}/.dotfiles/skhd";
      alacritty.source = "${config.home.homeDirectory}/.dotfiles/alacritty.toml";
    };
  };
